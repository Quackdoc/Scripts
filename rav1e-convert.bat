@echo off
echo "Correct usage is 'Input, Output, framerate, Color encoding"
color 6
...
:RUN
ffmpeg -i %INPUT% -pix_fmt %YUV% -r %FRAMERATE% -f yuv4mpegpipe -  | rav1e - --speed 10 --frame-rate %FRAMERATE% --output %OUTPUT%